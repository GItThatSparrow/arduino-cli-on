...
import tech.sorethumb.clion.view.renderers.impl.PlatformVersionItemRendererImpl;

import javax.swing.*;

public class PlatformVersionCellRenderer extends ListCellRendererWrapper<PlatformVersion> {
     ...
     */
    @Override
    public void customize (JList list, PlatformVersion value, int index, boolean selected, boolean hasFocus) {
        PlatformVersionItemRendererImpl itemRenderer = PlatformVersionItemRendererImpl.create(index, value);
